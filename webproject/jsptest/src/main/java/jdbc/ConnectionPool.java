...
public final class ConnectionPool{
    ...
    private String user = "hr";    private String password = "hr";
	...
	/* 초기 커넥션 개수를 각각의  ArrayList에 자장할 수 
	...
	Connection con = null;		
	try{
	    con = DriverManager.getConnection(url, user, password);		}catch (SQLException e){
		e.printStackTrace();			
	}
